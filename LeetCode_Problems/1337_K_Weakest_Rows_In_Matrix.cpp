/*
LeetCode Problem: 1337 - K Weakest Rows in a Matrix
Difficulty: Easy
Time Complexity: O(m * n log k), where m is the number of rows and n is the number of columns in the matrix.
Space Complexity: O(k), where k is the number of weakest rows to return.
